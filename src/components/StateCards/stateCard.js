...
class StateCards extends Component {
  ...
  totalDistrict = async () => {
    ...
    const confirmedCard = {
      name: "Confirmed",
      logo: "https://res.cloudinary.com/df5wssoz1/image/upload/v1696820101/samples/Covid19/check-mark_1_r4m79y.png",
      value: districtConfirmed,
    };

    const recoveredCard = {
      name: "Recovered",
      logo: "https://res.cloudinary.com/df5wssoz1/image/upload/v1696820101/samples/Covid19/recovered_1_jg6qzy.png",
      value: districtRecovered,
    };
    const deceasedCard = {
      name: "Deceased",
      logo: "https://res.cloudinary.com/df5wssoz1/image/upload/v1696820101/samples/Covid19/breathing_1_g6ixah.png",
      value: districtDeceased,
    };
    const activeCard = {
      name: "Active",
      logo: "https://res.cloudinary.com/df5wssoz1/image/upload/v1696820101/samples/Covid19/protection_1_vzyvni.png",
  ...
  render() {
    ...
    const { confirmedCard, recoveredCard, activeCard, deceasedCard } =
      this.state;
